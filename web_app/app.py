...
from utils.web_app_tools.login_logic import login_manager, authenticate
from utils.web_app_tools.forms import LoginForm, EditSingleSessionForm, EditGroupSessionForm
from utils.tools.web_app_tools import error_catcher

from utils.tools_for_db import get_session_by_id, get_group_session_by_id
from utils.tools_for_db.web_app_funcs import get_session_by_week, get_all_clients, \
    get_client_by_id, get_all_coaches, get_coach_by_id, session_delete_client

from utils.tools.web_app_tools import get_week_dates
...
def one_week_sessions():
    ...
    return render_template("one_week_sessions.html",
                           sessions=sessions,
                           status_colors=confg.status_colors,
                           enumerate=enumerate,
...
def one_week_group_sessions():
    ...
    return render_template("one_week_group_sessions.html",
                           ...
                           group_status_colors=confg.group_status_colors,
                           enumerate=enumerate,
                           week_number=week_number,
                           first_last_dates=first_last_dates,
...
def regenerate():
    ...
    encrypted_index = confg.cipher.encrypt(index)
...
def get_image(encrypted_index):
    ...
    index = int.from_bytes(confg.cipher.decrypt(encrypted_index_bytes), byteorder='big')
    image_name = confg.IMAGES_NAMES[index]
